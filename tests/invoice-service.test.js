...
// Helper: create a minimal InvoiceService-like calculator for pure unit tests
const InvoiceCalculator = {
    /**
     * Calculate netto, mwst, brutto from a base netto amount with 19% MwSt.
     */
    ...
    /**
     * Calculate netto, mwst, brutto with 7% reduced MwSt rate.
     */
    ...
    /**
     * Apply percentage discount to a netto amount.
     */
    ...
    /**
     * Format amount in German locale (1.234,56 €).
     */
...
// Minimal in-memory store-based invoice manager for state transition tests
...
describe('InvoiceService', () => {
    ...
    describe('Total Calculation - 19% MwSt', () => {
        ...
        it('should calculate 19% MwSt for large amount (German: 1.234,56 format awareness)', () => {
    ...
    describe('Required Field Validation', () => {
        it('should pass validation for valid invoice', () => {
            const result = InvoiceCalculator.validateInvoiceFields({
                kunde: { name: 'Test GmbH' },
                netto: 1000
            });
