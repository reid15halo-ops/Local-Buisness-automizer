    ...
    constructor() {
        ...
        if (!this.settings.serviceTypes) {
            this.settings.serviceTypes = [
                { id: 'erstberatung', name: 'Erstberatung (kostenlos)', duration: 60, price: 0 },
                { id: 'digital-audit', name: 'Digital-Audit (kostenlos)', duration: 90, price: 0 },
                { id: 'produktdemo', name: 'Produktdemo (Video-Call)', duration: 45, price: 0 },
                { id: 'onboarding', name: 'Onboarding-Termin', duration: 120, price: 0 }
            ];
        }
